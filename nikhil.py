...
def extract_valid_plate(text):
    """
    Extracts the valid license plate from a string by identifying text matching the format
    AA00AA0000, checking the first two characters against the VALID_STATE_CODES set,
    and ensuring no special symbols or lowercase letters.
    """
